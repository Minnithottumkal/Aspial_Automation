...
public class Email {
	...
	public static  void email()throws EmailException {
	    ...
	    final String to ="testingt919@gmail.com"; //change to to email address
	   // final String cc = "test.cc.email@helloselenium.com"; //change to cc email address
	    ...
	    final String subject = "Test Report and Logs of Aspial Automation"; //change to your subject
	    ...
	    try {
	      ...
	      String date2= dateFormat.format(date);
	        ...
	        String file1 = System.getProperty("user.dir")+"/target/surefire-reports/html/Aspial_Test_Result.html";	        		
	       // String fileName1 = "TestResult.html"; 
	        String fileName1 ="Aspial_Test_Result"+date2+".html";//change to your attachment filename
	        ...
	        String file2 = System.getProperty("user.dir")+"/target/surefire-reports/html/Aspial_Test_Log.log";	        		
	        String fileName2= "Aspial_Test_Logs"+date2+".log"; //change to your attachment filename
